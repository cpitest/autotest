	...
	public WebDriverWrapper(String driverName) throws Exception{
		...
		expectation = new ExpectedCondition<Boolean>(){
			public Boolean apply(WebDriver driver){
				// return ((JavascriptExecutor)driver).executeScript("return document.readyState == 'complete' && afnfblog.loading == false").equals(true);
				return ((JavascriptExecutor)driver).executeScript("return document.readyState == 'complete'").equals(true);
			}
		};
	}
