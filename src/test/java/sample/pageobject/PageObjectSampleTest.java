...
public class PageObjectSampleTest{
	...
	public void 宿泊予約が成功すること(){
		...
		inputPage.setReserveDate(Integer.toString(nextSaturday.get(Calendar.YEAR)), Integer.toString(nextSaturday.get(Calendar.MONTH) + 1), Integer.toString(nextSaturday.get(Calendar.DATE)));
